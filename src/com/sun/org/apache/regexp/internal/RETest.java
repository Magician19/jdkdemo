...
public class RETest
{
    ...
    void runInteractiveTests(String expr)
    {
        ...
        try
        {
            ...
            // User matching against compiled expression
            while ( running )
            {
                // Read from keyboard
    ...
    void testOther() throws Exception
    {
        ...
        // User MATCH_MULTILINE. User for eol/bol symbols.
        ...
        // User MATCH_MULTILINE. User that '.' does not matches new line.
    ...
    private void testSubst()
    {
        ...
        // User subst() with backreferences
        r = new RE("http://[\\.\\w\\-\\?/~_@&=%]+");
        ...
        // User subst() with backreferences without leading characters
        ...
        // User subst() with NO backreferences
        r = new RE("^a$");
        actual = r.subst("a",
