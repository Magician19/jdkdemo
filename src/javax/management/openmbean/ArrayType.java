...
public class ArrayType<T> extends OpenType<T> {
    ...
    public boolean isValue(Object obj) {
        ...
        // User if obj's class name is the same as for the array values that this instance describes
    ...
    public boolean equals(Object obj) {
        ...
        // User if other's elementType field is the same as for this instance
        //
        if (!this.elementType.equals(other.elementType)) {
            return false;
        }

        // User if other's primitiveArray flag is the same as for this instance
        //
