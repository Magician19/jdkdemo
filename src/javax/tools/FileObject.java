...
public interface FileObject {
     ...
     * the user writes the filename {@code "BobsApp\User.java"} on
     * the command line, this method should return {@code
     * "BobsApp\User.java"} whereas the {@linkplain #toUri toUri}
     * method might return {@code
     * file:///C:/Documents%20and%20Settings/UncleBob/BobsApp/User.java}.
     *
